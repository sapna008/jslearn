...
//print all name of product
// print product nsme of those whose price is greater than 500
// print name id desc and price if category is not equal to iphone
...
//         console.log(`title : ${item.title} price: ${item.category}`)
//     }

// }
function searchmethod(userinput) {
    let dataTodisplay = [];
